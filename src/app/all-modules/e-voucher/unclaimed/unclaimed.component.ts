...
@Component({
  selector: 'app-unclaimed',
  templateUrl: './unclaimed.component.html',
  styleUrls: ['./unclaimed.component.css']
})
export class UnclaimedComponent implements OnInit, OnDestroy {
